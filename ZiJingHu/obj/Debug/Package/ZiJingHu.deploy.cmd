...
set _DeploySetParametersFile=%RootPath%ZiJingHu.SetParameters.xml
)
...
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:archiveDir='%RootPath%Archive' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension
) else (
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:archiveDir='%RootPath%Archive' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%_DeploySetParametersFile%"
)
...
:usage
echo =========================================================
if not exist "%RootPath%ZiJingHu.deploy-readme.txt" (
...
start notepad "%RootPath%ZiJingHu.deploy-readme.txt"
)
echo =========================================================
goto :eof
